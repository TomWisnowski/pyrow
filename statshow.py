...
if __name__ == '__main__':
   ...
   ##  pickle.dump(ergs, filehandle)
    ...
    command = ['CSAFE_GETSTATUS_CMD', 'CSAFE_PM_GET_STROKESTATE', 'CSAFE_PM_GET_WORKOUTSTATE','CSAFE_GETPOWER_CMD', 'CSAFE_GETCADENCE_CMD', 'CSAFE_GETPACE_CMD', 'CSAFE_GETTWORK_CMD', 'CSAFE_GETUNITS_CMD']
    # command = [
...
# cmds['CSAFE_GETPOWER_CMD'] = [0xB4, []]]
    ...
    #Inf loop
    while 1:
        results = work_out_machine.send(command)
